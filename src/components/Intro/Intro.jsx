...
const Intro = () => {
  return (
    <h1><p>Ciao!!👋👋👋</p> <span className="title">Coordiniamo le attività sportive da sempre promosse all'interno degli Istituti Salesiani e degli Oratori.</span>Lo facciamo anche noi.........<span className="container-flip">
    ...
    <span className="flip flip-bookworm">celebrazione eucaristica.⛪⛪</span>
  </span>
  </h1>
  )
}
